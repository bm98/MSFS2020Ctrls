...
namespace MSFS2020Ctrls.Layout
{
  ...
  {
    /// <summary>
    /// Internal class to maintain PidVids used in this List
    /// </summary>
    ...
    /// <summary>
    /// Returns a list of PidVid referenced in this list
    /// </summary>
    public List<string> UsedPidVid {
      get {
        string[] k=new string[]{ };
        Array.Resize( ref k, m_trackers.Keys.Count );
        m_trackers.Keys.CopyTo( k, 0 );
        return k.ToList( );
      }
    }
